<x-layout-front title="Home - Wigati Buku">
    ...
    <section
        ...
        <div class="container mx-auto md:w-3/6 text-center md:text-left">
            <h4 class="text-2xl md:text-4xl font-bold mb-4 text-gray-600">Ribuan judul buku dari berbagai genre</h4>
            <p class="text-base md:text-lg mb-8 text-gray-600">fiksi, nonfiksi, bisnis, pendidikan, hingga buku anak.
                Lengkap.
                Terjangkau. Cepat
                sampai</p>
            <a href="#products"
                ...
                @forelse ($products as $product)
                    <div class="bg-white p-4 md:p-6 rounded-lg shadow-lg text-center hover:scale-105 transition">
                        <a href="{{ route('front.product.details', $product->slug) }}"
                            class="hover:scale-105 transition block">
    ...
    {{-- testimonial section --}}
    <section class="py-12 md:py-20 bg-gray-100 px-4 md:px-10">
        <div class="container mx-auto">
            <h2 class="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-10">What Our Customers Say</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                <div class="bg-white p-4 md:p-6 rounded-lg shadow-lg hover:scale-105 transition">
                    <h3 class="text-lg md:text-xl font-semibold mb-2">Hendry - Jogja</h3>
                    <p class="text-gray-600 mb-4">Recomend banget nih tokonya! jangan lupa checkout ya :)</p>
                </div>
                <div class="bg-white p-4 md:p-6 rounded-lg shadow-lg hover:scale-105 transition">
                    <h3 class="text-lg md:text-xl font-semibold mb-2">Dinda - Jakarta</h3>
                    <p class="text-gray-600 mb-4">Belanja di sini nyaman banget! Koleksinya lengkap dan pengirimannya
                        cepat.</p>
                </div>
                <div class="bg-white p-4 md:p-6 rounded-lg shadow-lg hover:scale-105 transition">
                    <h3 class="text-lg md:text-xl font-semibold mb-2">Reza - Bandung</h3>
                    <p class="text-gray-600 mb-4">Prosesnya gampang, nggak ribet. Dan yang paling saya suka, ada ulasan
                        asli dari pembaca lain. Jadi bisa pilih buku dengan percaya diri.</p>
                </div>
                <div class="bg-white p-4 md:p-6 rounded-lg shadow-lg hover:scale-105 transition">
                    <h3 class="text-lg md:text-xl font-semibold mb-2">Andy - Surabaya</h3>
    ...
    {{-- Cta section --}}
    <section class="py-12 md:py-20 px-4 md:px-10 bg-white">
        <div class="container mx-auto">
            <p class="text-lg md:text-2xl font-bold text-center text-gray-600 mb-6 px-2 md:px-6">Bayangkan… di ujung
                jari kamu ada ribuan
                buku inspiratif,
                novel seru,
    ...
    {{-- blog section --}}
    <section class="py-12 md:py-20 px-4 md:px-10 bg-gray-50">
        <div class="container mx-auto ">
