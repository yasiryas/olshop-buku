                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-800">{{ count($myOrders ?? []) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @forelse($myOrders ?? [] as $order)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <a href="{{ route('product_transactions.show', $order->id) }}"
                                                    class="text-blue-600 hover:text-blue-900">View Details</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="5" class="px-6 py-4 text-center text-gray-500">No orders
                                                yet. <a href="{{ route('front.product') }}"
                                                    class="text-red-600 hover:underline">Start shopping!</a></td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
